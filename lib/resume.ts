...
export const achievements: Card[] = [
  ...
  },
  {
    ...
    points: [
      "National top five of 1,500+ registrations across 11 MBA campuses",
      "Awarded a pre-placement interview with BCG",
    ],
    year: "2024",
  ...
  },
  {
    ...
    points: [
      "Podium in Energize, JSW Energy's case challenge at ISB's Advaita 2024",
      "Awarded a pre-placement interview with JSW Energy",
    ],
    year: "2024",
  ...
  },
  {
    ...
    tag: "National Winner",
    points: [
      "Winner out of 70,980 participants from premier institutes across India",
      "Driver Earnings Improvement, Driver Empowerment track",
      "Conceptualised the Co-pilot for Auto Drivers model",
    ],
    year: "2023",
  ...
  },
  {
    ...
    points: [
      "Podium at the Institute of Management Accountants' India finals",
